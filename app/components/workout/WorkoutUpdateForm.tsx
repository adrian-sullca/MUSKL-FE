...
export default function WorkoutUpdateForm() {
  ...
  const renderStep2 = () => (
    <>
      <h1 className="text-center text-lg text-primary-color-200 font-semibold uppercase italic">
        ...
        <br />
        <div className="text-sm normal-case text-primary-color-400">
          Actualiza el ejercicio y sus notas
        </div>
      </h1>
  ...
  const renderStep3 = () => (
    <>
      <h1 className="text-center text-lg text-primary-color-200 font-semibold uppercase italic">
        ¿Cambios en el equipamento?
        <br />
        <div className="text-sm normal-case text-primary-color-400">
          Actualiza el equipamento
        </div>
      </h1>
  ...
  const renderStep4 = () => (
    <>
      <h1 className="text-center text-lg text-primary-color-200 font-semibold uppercase italic">
        ¿Cambios en las series o reps?
        <br />
        <div className="text-sm normal-case text-primary-color-400">
          Actualiza numero de series y repeticiones
        </div>
      </h1>
  ...
  const renderStep5 = () => (
    <>
      <h1 className="text-center text-lg text-primary-color-200 font-semibold uppercase italic">
        Resumen actualizado del ejercicio
        <br />
        <div className="text-sm normal-case text-primary-color-400">
          Confirma los datos para actualizar el ejercicio
        </div>
      </h1>
